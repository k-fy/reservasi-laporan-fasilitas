...
function App() {
  ...
  // PINDAHKAN STATE INI KE DALAM FUNGSI APP()
    ...
    <div className="app">
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <h1>
            Looking for your
            <br />
            <span className="italic-perfect">Perfect</span> Venue?
          </h1>
        ...
        <div className="availability-card">
          ...
          {/* BAGIAN START TIME & END TIME BERDAMPINGAN */}
      ...
      <section className="section announcements">
        ...
        <div className="announcement-grid">
          <div className="announcement-card">
            <p>03/09/2026</p>
            <h3>Jadwal Pemeliharaan Aula</h3>
            <span>Aula utama akan ditutup sementara untuk pemeliharaan rutin.</span>
            <a href="#">Read more ›</a>
          </div>
          <div className="announcement-card">
            <p>03/09/2026</p>
            <h3>Fitur Reservasi Baru</h3>
            <span>Sekarang kamu bisa cek ketersediaan fasilitas langsung dari halaman utama.</span>
            <a href="#">Read more ›</a>
          </div>
          <div className="announcement-card">
            <p>03/09/2026</p>
            <h3>Jam Operasional Berubah</h3>
            <span>Jam operasional gedung diperbarui mulai bulan ini.</span>
            <a href="#">Read more ›</a>
          </div>
        </div>
      </section>
      ...
      <section className="section how-to">
        ...
        <div className="steps">
          <div className="step-card">
            ...
            <p>Search and select the space you want to book</p>
          </div>
          <div className="step-card">
            <div className="number">2</div>
            <h3>Choose your date & time</h3>
            <p>Pick your preferred schedule for the reservation</p>
          </div>
          <div className="step-card">
            <div className="number">3</div>
            <h3>Confirm & Done</h3>
            <p>Finalize your order</p>
          </div>
        </div>
      </section>
      ...
      <section className="section faq">
        ...
        <div className="faq-list">
          <details open>
            <summary>Bagaimana cara reservasi fasilitas? <span>×</span></summary>
            <div className="faq-answer">
              Pilih fasilitas yang ingin digunakan, tentukan tanggal dan waktu, kemudian lakukan reservasi.
            </div>
          </details>
          <details>
            <summary>Apakah reservasi bisa dibatalkan? <span>□</span></summary>
            <div className="faq-answer">
              Ya, reservasi dapat dibatalkan sesuai dengan ketentuan yang berlaku.
            </div>
          </details>
          <details>
            <summary>Berapa lama proses persetujuan reservasi? <span>□</span></summary>
            <div className="faq-answer">
      ...
      <footer>
        <div className="footer-content">
          <div className="footer-about">
            <h2>About Chloe</h2>
            <p>
              Chloe is the premier digital hub for booking campus venues and facilities,
              designed to make event planning seamless for students and staff.
            </p>
          </div>
          ...
          <div className="footer-copyright">
            <p>© 2026 Barbie Charm University. All rights reserved.</p>
          </div>
        </div>
      </footer>
